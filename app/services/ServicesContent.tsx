        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20 items-center">
          <div data-aos="fade-right">
            <img
              ...
              alt="Apartment and villa finishing in Cairo and Giza - تشطيب شقق وفلل"
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20 items-center">
          <div className="md:order-2" data-aos="fade-left">
            <img
              ...
              alt="High quality finishing material supply Cairo and Giza - توريد خامات تشطيب"
              className="rounded-lg w-full h-auto border-2 border-[#dabe6d]"
            />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20 items-center">
          <div data-aos="fade-right">
            <img
              ...
              alt="Construction and finishing project supervision Cairo and Giza - إشراف على مشاريع التشطيب"
              className="rounded-lg w-full h-auto border-2 border-[#dabe6d]"
            />
          </div>
          <div data-aos="fade-left">
